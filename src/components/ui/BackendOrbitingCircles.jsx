...
export function BackendOrbitingCircles() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg shadow-black shadow-md">
...
const Icons = {
  ...
  mysql: () => (
    <svg class="w-40 h-40 object-contain" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 252">
