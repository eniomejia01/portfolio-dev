...
export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg  bg-background shadow-black shadow-md mb-10">
...
const Icons = {
  html: () => (
    <svg class="md:w-40 md:h-40 w-full h-full md:object-contain"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520">
  ...
  css: () => (
    <svg class="md:w-40 md:h-40 w-full h-full object-contain"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520">
